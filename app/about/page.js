  ...
  return (
    <>
      <div className="bg-black">
        <section
          id="features"
          className="relative block px-6 py-10 md:py-10 md:px-10 border-t border-b border-neutral-700 bg-neutral-900/30"
        >
          <div className="mx-[-10px] md:px-10 my-5 ">
            ...
            <p className="p-4 text-gray-200 text-md text-center font-sans">
              At 'Cheers with Tea', we are committed to fostering a vibrant
            ...
            <p className="p-4 text-gray-200 text-md text-center font-sans">
              ...
              an influencer sharing your unique perspective with the world, 'Cheers with Tea' is here to support you every step of the way.
            </p>
            <p className="p-4 text-gray-200 text-md text-center font-sans">
            ...
            <p className="p-4 text-gray-200 text-md text-center font-sans">
              At 'Cheers with Tea', we take pride in helping creators reach their
          ...
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(to left bottom, rgba(1, 70, 229, 0.2) 0%, transparent 50%, transparent 100%)",
              borderColor: "rgba(400, 79, 240, 0.2)",
            }}
          ></div>
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(to right bottom, rgba(400, 38, 38, 0.2) 0%, transparent 50%, transparent 100%)",
          ...
          <div className="relative mx-auto max-w-5xl text-center">
            ...
            <p className="mx-auto my-4 w-full max-w-xl bg-transparent text-center font-medium leading-relaxed tracking-wide text-gray-400">
              At 'Cheers with Tea', we empower developers, creators, and influencers
          ...
          <div className="relative mx-auto max-w-7xl z-10 grid grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
              ...
              <p className="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">
                Our platform is quite versatile and easy to use. You won't face any problem using our website.
              </p>
            </div>
