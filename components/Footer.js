...
const Footer = () => {
  ...
  return (
   <footer className='bg-gray-900 text-white px-4 md:h-16 flex items-center justify-around flex-col md:flex-row gap-5 h-full'>
    <p className='text-center relative xl:left-[340px]'>Copyright &copy; {currentYear} Cheers with Tea - All rights reserved</p>


<div className="follow">
  
    {/* <h2 className="font-bold underline">Follow me</h2> */}
